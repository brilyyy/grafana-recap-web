...
CREATE INDEX idx_raw_qris_n8n_feature ON public.raw_qris_n8n USING btree (
    feature
);
CREATE INDEX idx_raw_qris_n8n_reference_number ON public.raw_qris_n8n USING btree (
    reference_number
);
CREATE INDEX idx_raw_qris_n8n_response_code ON public.raw_qris_n8n USING btree (
    response_code
);
CREATE INDEX idx_raw_qris_n8n_trx_timestamp ON public.raw_qris_n8n USING btree (
    trx_timestamp
);
