...
export default function AppListCard() {
  ...
  return (
    <div
      className="bg-card border shadow-xs rounded-xl p-3 md:p-4 h-full flex flex-col transform transition-all duration-300 hover:scale-[1.01] hover:shadow-2xl border border-white/20 will-change-transform"
    ...
    >
      ...
      <div
        className="flex-1 overflow-y-auto mb-1.5 border border-gray-200/50 rounded-md bg-white/60 backdrop-blur-sm shadow-inner min-h-0"
