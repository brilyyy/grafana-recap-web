    ...
    <div className="flex flex-col gap-6 p-6">
      <header>
        ...
        <p className="text-sm text-muted-foreground">
          {'Response-code mappings across apps, plus unclassified codes ready for review.'}
        </p>
      </header>
        ...
        <section className="flex flex-col gap-3">
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              {
                'Classify response codes with no error-type mapping yet. Submitted codes move straight into the dictionary.'
              }
            </p>
          </div>
          <UnmappedRcCard />
