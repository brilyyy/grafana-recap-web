...
export const appProcessingLog = pgTable(
  ...
  (t) => [
    index('idx_app_processing_date').on(t.appName, t.processingDate),
    index('idx_apl_status').on(t.status, t.createdAt),
    index('idx_app_processing_log_processing_date').on(t.processingDate),
    index('idx_apl_catalog_entry_date').on(t.catalogEntryId, t.processingDate),
  ],
)
...
export const auditLogs = pgTable(
  ...
  (t) => [
    ...
    index('idx_audit_resource_type').on(t.resourceType),
