...
title: EDC Merchant — success rate (daily)
output_table: app_success_rate
function_name: sp_process_edc_merchant_daily
scope_type: per_app
app_key: edc_merchant
raw_sql_repo_path: src/db/sql/reference/success_rate/edc_merchant.raw.sql
description: H-1 recap of transaction success metrics into app_success_rate for EDC Merchant.
