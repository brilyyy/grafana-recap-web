...
function_name: sp_process_bale_daily
scope_type: per_app
app_key: bale
raw_sql_repo_path: src/db/sql/reference/success_rate/bale.raw.sql
description: H-1 recap of transaction success metrics into app_success_rate for Bale.
...
brief_query: FROM raw_bale: aggregate by day, jenis, RC, status; map dictionary error_type; INSERT app_success_rate.
@endmeta */
