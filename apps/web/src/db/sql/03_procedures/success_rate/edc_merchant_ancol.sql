/* @meta
id: sr:edc_merchant_ancol
recap_kind: success_rate_daily
title: EDC Merchant Ancol — success rate (daily)
output_table: app_success_rate
function_name: sp_process_edc_merchant_ancol_daily
scope_type: per_app
app_key: edc_merchant_ancol
raw_sql_repo_path: src/db/sql/reference/success_rate/edc_merchant_ancol.raw.sql
description: H-1 recap of transaction success metrics into app_success_rate for EDC Merchant Ancol.
brief_process_summary: Reads the app raw / FDW source for the processing day, normalizes RCs, joins response_code_dictionary, and replaces rows in app_success_rate for that app and date.
brief_query: FROM ZTRANS0P (ITM/FDW): aggregate; INSERT app_success_rate.
@endmeta */
-- EDC Merchant Ancol: reads from ASID160448_ZTRANS0P + ASID160448_ZRSPCD0P (via FDW from itm_db)
-- Filter: TRTRTY = '21', TRPROD = 'POS', TRCAID IN (Ancol terminal IDs)
CREATE OR REPLACE FUNCTION public.sp_process_edc_merchant_ancol_daily(p_processing_date DATE DEFAULT NULL)
RETURNS void AS $$
DECLARE
  v_app_id INT;
  v_app_name VARCHAR(255) := 'EDC Merchant Ancol';
...
BEGIN
  ...
  VALUES (v_app_name, v_app_id, v_processing_date, NOW(), 'running', 'sr:edc_merchant_ancol')
    ...
    FOR rec IN
      ...
      WHERE t."TRTRTY" = '21'
        ...
        AND t."TRCAID" IN (
          ...
          '200719392284951','200719392281161','200719392293973','200719392300602','200719392299553',
          '200719389824014','200719389830246','200719389828737','200719392280238','200719392277795',
          '200719389823080','200719389827804','200719392276862','200719389829660','200719392297696',
          '200719392298620','200719389825947','200719389826870','200719392286818','200719392279652',
          '200719392295830','200719392294907','200719392296763','200719392285884','200719389831179',
          '200719392278729','200719392301535','200719389801323','200719389800399','200719389822157',
          '200719392271216','200719392273072','200719392274006','200719389821224','200719392272149',
          '200719389820290','200719392275939','160016154115765','160016154115772','160016154115777',
          '160016154115778','160016154115780','160016154115781','160016154115783','160016154115785',
          '160016154115773','160016154115775','160016154115774','160016154115776','160016154115771',
          '160016154115779','160016154115770','160016154115782','160016154115769','160016154115766',
          '160016154115767','160016154115768','160016154115784','160016154115786','160016154115787',
          '160016154115788','160016154115789','160016154115790','160016154115791','160016154115792',
          '160016158125758','160016158125731','160016158125759','160016154115764','160016158125760',
          '160016158125761','160016158125762','160016158125763'
        )
