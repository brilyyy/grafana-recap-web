...
title: Bale Bisnis — success rate (daily)
output_table: app_success_rate
function_name: sp_process_bale_bisnis_daily
scope_type: per_app
app_key: bale_bisnis
raw_sql_repo_path: src/db/sql/reference/success_rate/bale_bisnis.raw.sql
description: H-1 recap of transaction success metrics into app_success_rate for Bale Bisnis.
...
brief_query: FROM raw_bale_bisnis: matrix-style aggregate; INSERT app_success_rate (see raw.sql).
@endmeta */
...
BEGIN
  ...
  VALUES (v_app_name, v_app_id, v_processing_date, NOW(), 'running', 'sr:bale_bisnis')
